...
void triggerAnalysisSimple_PuJetsEta2p1_noL1Seed(std::string triggerFile = "openHLT_CB2_merge.root",
    ...
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet40Eta2p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet60Eta2p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet80Eta2p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet100Eta2p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet120Eta2p1_noL1Seed_v", 1);
    ...
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet40Eta2p1_noL1Seed_v",&triggerDecision_40);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet60Eta2p1_noL1Seed_v",&triggerDecision_60);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet80Eta2p1_noL1Seed_v",&triggerDecision_80);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet100Eta2p1_noL1Seed_v",&triggerDecision_100);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet120Eta2p1_noL1Seed_v",&triggerDecision_120);
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    auto wf = TFile::Open("rootFiles/out_PuJetsEta2p1_noL1Seed.root","recreate");
