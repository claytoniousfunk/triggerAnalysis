...
void triggerAnalysisSimple_CsJetsEta2p1_noL1Seed(std::string triggerFile = "openHLT_CB_merge.root",
    ...
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet60Eta2p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet80Eta2p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet100Eta2p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet120Eta2p1_noL1Seed_v", 1);
    ...
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet60Eta2p1_noL1Seed_v",&triggerDecision_60);
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet80Eta2p1_noL1Seed_v",&triggerDecision_80);
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet100Eta2p1_noL1Seed_v",&triggerDecision_100);
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet120Eta2p1_noL1Seed_v",&triggerDecision_120);
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    auto wf = TFile::Open("rootFiles/out_CsJetsEta2p1_noL1Seed.root","recreate");
