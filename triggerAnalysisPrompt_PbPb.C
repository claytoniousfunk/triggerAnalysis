...
void triggerAnalysisPrompt_PbPb(int file_i = 1){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_triggerAnalysisPrompt_HIPhysicsRawPrime0_399467_CaloJetPT_2025-11-15/out_%i.root",file_i);
