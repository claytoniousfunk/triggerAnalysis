...
void triggerAnalysisPrompt_PbPb(int file_i = 1){
  ...
  std::ifstream infile("./fileNames/fileNames_HIPhysicsRawPrime0to2_399467.txt");
  if(!infile.is_open()){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_triggerAnalysisPrompt_HIPhysicsRawPrime0to2_399467_CaloJetPT/out_%i.root",file_i);
