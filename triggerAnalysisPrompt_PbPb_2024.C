...
void triggerAnalysisPrompt_PbPb_2024(int file_i = 1){

  std::ifstream infile("./fileNames/fileNames_HIRun2024A_HIPhysicsRawPrime0.txt");
  if(!infile.is_open()){
  ...
  TString output = Form("/eos/cms/store/group/phys_heavyions/cbennett/scanningOutput/output_triggerAnalysisPrompt_HIRun2024A_HIPhysicsRawPrime0_CaloJetPT/out_%i.root",file_i);
  ...
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet40Eta5p1_MinBiasHF1AND_v6",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet60Eta5p1_MinBiasHF1AND_v6",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet80Eta5p1_v14",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet100Eta5p1_v14",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet120Eta5p1_v14",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet40Fwd_v7",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet60Fwd_v7",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet80Fwd_v7",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet100Fwd_v7",1);
  treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet120Fwd_v7",1);
