...
void triggerAnalysisSimple_CsJetsEta2p1(std::string triggerFile = "openHLTFiles_21Sep22.root",
                           std::string inputFile = "HiForestMiniAOD_CB_merge.root",
                           std::string outputFile = "rootFiles/out_CsJetsEta2p1.root"){
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    auto wf = TFile::Open("rootFiles/out_CsJetsEta2p1.root","recreate");
