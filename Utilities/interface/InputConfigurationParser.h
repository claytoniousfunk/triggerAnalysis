...
std::vector<std::string> InputConfigurationParser::parseKeyWords(std::string dataFile)
{
    ...
    std::cout << "[InputConfigurationParser] argsStr = " << argsStr.at(0) << std::endl;
    std::vector<int> argsInt = {HiForestInfoController::getCollisionType(dataFiles[0])};

    
    //std::cout << "[InputConfigurationParser] argsInt retrieved!" << std::endl;
    std::cout << "[InputConfigurationParser] argsInt = " << argsInt.at(0) << std::endl;
