...
const std::string times = "_$TIMES$_";       // operator for multiple lists
const std::string plus = "_$PLUS$_";       // operator for multiple lists
...
std::string ConfigurationParser::ParseSampleName(std::string fileName)
{
    ...
    std::cout << "[ConfigurationParser::ParseSampleName] fileName = " << res << std::endl;
    ...
    std::cout << "[ConfigurationParser::ParseSampleName] res = " << res << std::endl;
...
std::vector<std::string> ConfigurationParser::ParseKeyWords(std::vector<std::string> argsStr, std::vector<int> argsInt)
{
    ...
    std::cout << "[ConfigurationParser::ParseKeyWords] ParseSampleName = " << res[CONFIGPARSER::k_PARSESAMPLENAME] << std::endl;
...
{
    std::cout << "[ConfigurationParser::ReadConfigValueInteger] Input to std::atoi = " << ReadConfigValue(configName).c_str() << std::endl;
