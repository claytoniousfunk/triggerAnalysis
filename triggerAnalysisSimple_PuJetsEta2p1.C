...
TH1D *eta_r_100 = new TH1D("eta_r_100","eta_r_100",Nbins,ptMin,ptMax);
...
TH1D *eta_r_120 = new TH1D("eta_r_120","eta_r_120",Nbins,ptMin,ptMax);
...
void triggerAnalysisSimple_PuJetsEta2p1(std::string triggerFile = "openHLT_merge_5Sep22.root",
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
	...
	weight *= weight_Ncoll;
        ...
        if(fabs(maxEta_denom)>2.1) continue; // skip event if the leading jet is outside eta range

	    if(maxPt_denom > 0) {
            
            denom->Fill(maxPt_denom,weight);
            if(maxPt_denom > 20) eta_denom->Fill(maxEta_denom,weight);
        ...
        if(triggerDecision_40) {// only fill the numerator if the trigger is on.
            ...
            if(maxPt_num > 0){
                ...
                if(maxPt_num > 20) eta_num_40->Fill(maxEta_num,weight);
        ...
        if(triggerDecision_60) {// only fill the numerator if the trigger is on.
            ...
            if(maxPt_num > 0){
                ...
                if(maxPt_num > 20) eta_num_60->Fill(maxEta_num,weight);
                //std::cout << "maxPt_num = " << maxPt_num << std::endl <<  std::endl;
            } 
        ...
        if(triggerDecision_80) {// only fill the numerator if the trigger is on.
            ...
            if(maxPt_num > 0){
                ...
                if(maxPt_num > 20) eta_num_80->Fill(maxEta_num,weight);
                //std::cout << "maxPt_num = " << maxPt_num << std::endl <<  std::endl;
            } 
        ...
        if(triggerDecision_100) {// only fill the numerator if the trigger is on.
            ...
            if(maxPt_num > 0){
                ...
                if(maxPt_num > 20) eta_num_100->Fill(maxEta_num,weight);
                //std::cout << "maxPt_num = " << maxPt_num << std::endl <<  std::endl;
            } 
        ...
        if(triggerDecision_120) {// only fill the numerator if the trigger is on.
            ...
            if(maxPt_num > 0){
                ...
                if(maxPt_num > 20) eta_num_120->Fill(maxEta_num,weight);
                //std::cout << "maxPt_num = " << maxPt_num << std::endl <<  std::endl;
            } 
    ...
    TLegend *leg = new TLegend(0.44,0.72,0.88,0.88);
    leg->AddEntry(r_40,"HLT_HIPuAK4CaloJet40Eta2p1_v","p");
    leg->AddEntry(r_60,"HLT_HIPuAK4CaloJet60Eta2p1_v","p");
    leg->AddEntry(r_80,"HLT_HIPuAK4CaloJet80Eta2p1_v","p");
    leg->AddEntry(r_100,"HLT_HIPuAK4CaloJet100Eta2p1_v","p");
    leg->AddEntry(r_120,"HLT_HIPuAK4CaloJet120Eta2p1_v","p");
    ...
    la->DrawLatexNDC(0.18,0.73,"|#eta^{jet}| < 2.1");
