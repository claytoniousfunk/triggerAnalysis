...
TH1D *eta_num_40 = new TH1D("eta_num_40","eta_num_40",NEtaBins,etaMin,etaMax);
TH1D *r_40 = new TH1D("r_40","r_40",Nbins,ptMin,ptMax);
TH1D *eta_r_40 = new TH1D("eta_r_40","eta_r_40",NEtaBins,etaMin,etaMax);
...
TH2D *h_matchedRecoJetPtOverGenJetPt_genJetPt_40[5];
...
void triggerAnalysisSimple_PuJetsEta5p1_noL1Seed(std::string triggerFile = "openHLT_merge_5Sep22.root",
                           std::string inputFile = "HiForestMiniAOD_CB_merge.root",
                           std::string outputFile = "rootFiles/out_CsJetsEta1p5.root"){


	h_matchedRecoJetPtOverGenJetPt_genJetPt_40[0] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_40_C0","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-90%",500,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_40[1] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_40_C1","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-10%",500,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_40[2] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_40_C2","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 10-30%",500,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_40[3] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_40_C3","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 30-50%",500,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_40[4] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_40_C4","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 50-90%",500,0,5,100,0,500);
    ...
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet40Eta5p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet60Eta5p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet80Eta5p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet100Eta5p1_noL1Seed_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet120Eta5p1_noL1Seed_v", 1);
    ...
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet40Eta5p1_noL1Seed_v",&triggerDecision_40);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet60Eta5p1_noL1Seed_v",&triggerDecision_60);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet80Eta5p1_noL1Seed_v",&triggerDecision_80);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet100Eta5p1_noL1Seed_v",&triggerDecision_100);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet120Eta5p1_noL1Seed_v",&triggerDecision_120);
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
	...
	for(Int_t i_jet = 0; i_jet < nref; i_jet++){
		...
		for(Int_t j_gen = 0; j_gen < ngen; j_gen++){
			...
			if(dR_recoGen < epsilon_dR){
				hasGenJetMatch = true;
				h_matchedRecoJetPtOverGenJetPt_genJetPt_40[0]->Fill(recoJetPt/genJetPt,genJetPt,weight);	
				if(hiBin >= 0 && hiBin < 20) h_matchedRecoJetPtOverGenJetPt_genJetPt_40[1]->Fill(recoJetPt/genJetPt,genJetPt,weight);	
				if(hiBin >= 20 && hiBin < 60) h_matchedRecoJetPtOverGenJetPt_genJetPt_40[2]->Fill(recoJetPt/genJetPt,genJetPt,weight);	
				if(hiBin >= 60 && hiBin < 100) h_matchedRecoJetPtOverGenJetPt_genJetPt_40[3]->Fill(recoJetPt/genJetPt,genJetPt,weight);	
				if(hiBin >= 100 && hiBin <= 180) h_matchedRecoJetPtOverGenJetPt_genJetPt_40[4]->Fill(recoJetPt/genJetPt,genJetPt,weight);	
			}
		}
            ...
            if(maxPt_num > 0){
                ...
                if(maxPt_num > 50) eta_num_40->Fill(maxEta_num,weight);
    ...
    eta_r_40->Divide(eta_num_40,eta_denom,1,1,"B");
    ...
    r_120->SetLineColor(kBlue-9);
    
    eta_r_40->SetLineColor(kRed);
    eta_r_60->SetLineColor(kBlue);
    eta_r_80->SetLineColor(kGreen);
    eta_r_100->SetLineColor(kMagenta);
    eta_r_120->SetLineColor(kBlue-9);
    ...
    r_120->SetMarkerColor(kBlue-9);
    
    eta_r_40->SetMarkerColor(kRed);
    eta_r_60->SetMarkerColor(kBlue);
    eta_r_80->SetMarkerColor(kGreen);
    eta_r_100->SetMarkerColor(kMagenta);
    eta_r_120->SetMarkerColor(kBlue-9);
    ...
    r_120->SetMarkerStyle(33);
    
    eta_r_40->SetMarkerStyle(24);
    eta_r_60->SetMarkerStyle(25);
    eta_r_80->SetMarkerStyle(26);
    eta_r_100->SetMarkerStyle(32);
    eta_r_120->SetMarkerStyle(33);
    ...
    r_40->GetXaxis()->SetTitle("leading CsJet #font[52]{p}_{T} [GeV]");
    r_40->GetYaxis()->SetTitle("Trigger efficiency");
    r_40->GetYaxis()->SetRangeUser(0.0,2.0);
    TLegend *leg = new TLegend(0.48,0.72,0.88,0.88);
    leg->AddEntry(r_40,"HLT_HIPuAK4CaloJet40Eta1p5_noL1Seed_v","p");
    leg->AddEntry(r_60,"HLT_HIPuAK4CaloJet60Eta1p5_noL1Seed_v","p");
    leg->AddEntry(r_80,"HLT_HIPuAK4CaloJet80Eta1p5_noL1Seed_v","p");
    leg->AddEntry(r_100,"HLT_HIPuAK4CaloJet100Eta1p5_noL1Seed_v","p");
    leg->AddEntry(r_120,"HLT_HIPuAK4CaloJet120Eta1p5_noL1Seed_v","p");
    ...
    p2->Draw();
    p2->cd();
    eta_r_40->GetYaxis()->SetRangeUser(0,1.05);
    eta_r_40->SetTitle("");
    eta_r_40->SetStats(0);
    eta_r_40->GetXaxis()->SetTitleSize(0.05);
    eta_r_40->GetYaxis()->SetTitleSize(0.05);
    eta_r_40->GetXaxis()->SetTitle("leading jet #eta");
    eta_r_40->GetYaxis()->SetTitle("Trigger efficiency");
    ...
    auto wf = TFile::Open("rootFiles/out_PuJetsEta5p1_noL1Seed.root","recreate");
	...
	for(int i = 0; i < 5; i++){
		...
		h_matchedRecoJetPtOverGenJetPt_genJetPt_40[i]->Write();
