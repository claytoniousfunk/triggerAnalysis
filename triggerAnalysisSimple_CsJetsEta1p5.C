...
void triggerAnalysisSimple_CsJetsEta1p5(std::string triggerFile = "openHLT_merge_5Sep22.root",
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    auto wf = TFile::Open("rootFiles/out_CsJetsEta1p5_C0_pthatFilter.root","recreate");
