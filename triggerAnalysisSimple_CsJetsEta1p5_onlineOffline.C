...
void triggerAnalysisSimple_CsJetsEta1p5_onlineOffline(std::string triggerFile = "openHLT_merge_5Sep22.root",
	...
	h_onlineJetPt_offlineJetPt_60[0] = new TH2D("h_onlineJetPt_offlineJetPt_60_C0","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, |#eta^{jet}| < 5.0",100,0,500,100,0,500);
	h_onlineJetPt_offlineJetPt_60[1] = new TH2D("h_onlineJetPt_offlineJetPt_60_C1","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, |#eta^{jet}| < 1.3",100,0,500,100,0,500);
	h_onlineJetPt_offlineJetPt_60[2] = new TH2D("h_onlineJetPt_offlineJetPt_60_C2","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, 1.3 < |#eta^{jet}| < 2.5",100,0,500,100,0,500);
	h_onlineJetPt_offlineJetPt_60[3] = new TH2D("h_onlineJetPt_offlineJetPt_60_C3","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, 2.5 < |#eta^{jet}| < 3.0",100,0,500,100,0,500);
	h_onlineJetPt_offlineJetPt_60[4] = new TH2D("h_onlineJetPt_offlineJetPt_60_C4","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, 3.0 < |#eta^{jet}| < 5.0",100,0,500,100,0,500);
    ...
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet60Eta1p5_v", 1);
    ...
    std::string treeOnlineJetPath = "hltobject/HLT_HICsAK4PFJet60Eta1p5_v";
    ...
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet60Eta1p5_v",&triggerDecision_60);
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
	...
	treeOnlineJet->GetEntry(i_entry);
		...
		if(hasOnlineMatch){
			...
			if(fabs(maxEta_num) < 5.0) h_onlineJetPt_offlineJetPt_60[0]->Fill(saveOnline_pt,maxPt_num,weight);
		       	if(fabs(maxEta_num) < 1.3) h_onlineJetPt_offlineJetPt_60[1]->Fill(saveOnline_pt,maxPt_num,weight);
		       	if(fabs(maxEta_num) > 1.3 && fabs(maxEta_num) < 2.5) h_onlineJetPt_offlineJetPt_60[2]->Fill(saveOnline_pt,maxPt_num,weight);
		       	if(fabs(maxEta_num) > 2.5 && fabs(maxEta_num) < 3.0) h_onlineJetPt_offlineJetPt_60[3]->Fill(saveOnline_pt,maxPt_num,weight);
		       	if(fabs(maxEta_num) > 3.0 && fabs(maxEta_num) < 5.0) h_onlineJetPt_offlineJetPt_60[4]->Fill(saveOnline_pt,maxPt_num,weight);
