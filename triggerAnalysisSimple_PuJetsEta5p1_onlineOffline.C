...
TH2D *h_onlineJetPt_offlineJetPt_60[5];
...
float getDr(float b, float c, float y, float z)
{
	// b, y = eta values
	// c, z = phi values
	float result = -1.0;
	float dEta = b - y;
	float dPhi = acos(cos(c - z));
	result = TMath::Sqrt(TMath::Power(dEta, 2) + TMath::Power(dPhi, 2));
	return result;
}


void triggerAnalysisSimple_PuJetsEta5p1_onlineOffline(std::string triggerFile = "openHLT_merge_5Sep22.root",
                           std::string inputFile = "HiForestMiniAOD_CB_merge.root",
                           std::string outputFile = "rootFiles/test.root"){




	h_matchedRecoJetPtOverGenJetPt_genJetPt_60[0] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_60_C0","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-90%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_60[1] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_60_C1","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-10%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_60[2] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_60_C2","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 10-30%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_60[3] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_60_C3","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 30-50%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_60[4] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_60_C4","jet60 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 50-90%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_80[0] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_80_C0","jet80 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-90%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_80[1] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_80_C1","jet80 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-10%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_80[2] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_80_C2","jet80 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 10-30%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_80[3] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_80_C3","jet80 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 30-50%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_80[4] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_80_C4","jet80 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 50-90%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_100[0] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_100_C0","jet100 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-90%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_100[1] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_100_C1","jet100 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-10%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_100[2] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_100_C2","jet100 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 10-30%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_100[3] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_100_C3","jet100 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 30-50%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_100[4] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_100_C4","jet100 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 50-90%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_120[0] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_120_C0","jet120 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-90%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_120[1] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_120_C1","jet120 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 0-10%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_120[2] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_120_C2","jet120 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 10-30%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_120[3] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_120_C3","jet120 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 30-50%",50,0,5,100,0,500);
	h_matchedRecoJetPtOverGenJetPt_genJetPt_120[4] = new TH2D("h_matchedRecoJetPtOverGenJetPt_genJetPt_120_C4","jet120 trigger, RecoJetPt/GenJetPt vs GenJetPt, PYTHIA+HDYJET 50-90%",50,0,5,100,0,500);

	
	h_onlineJetPt_offlineJetPt_60[0] = new TH2D("h_onlineJetPt_offlineJetPt_60_C0","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, |#eta^{jet}| < 5.0",100,0,5,200,0,1000);
	h_onlineJetPt_offlineJetPt_60[1] = new TH2D("h_onlineJetPt_offlineJetPt_60_C1","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, |#eta^{jet}| < 1.3",100,0,5,200,0,1000);
	h_onlineJetPt_offlineJetPt_60[2] = new TH2D("h_onlineJetPt_offlineJetPt_60_C2","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, 1.3 < |#eta^{jet}| < 2.5",100,0,5,200,0,1000);
	h_onlineJetPt_offlineJetPt_60[3] = new TH2D("h_onlineJetPt_offlineJetPt_60_C3","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, 2.5 < |#eta^{jet}| < 3.0",100,0,5,200,0,1000);
	h_onlineJetPt_offlineJetPt_60[4] = new TH2D("h_onlineJetPt_offlineJetPt_60_C4","offlineJetPt vs onlineJetPt, PYTHIA+HYDJET 0-90%, 3.0 < |#eta^{jet}| < 5.0",100,0,5,200,0,1000);
    ...
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet80Eta1p5_v", 1);
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet100Eta1p5_v", 1);
    treeTrig->SetBranchStatus("HLT_HICsAK4PFJet120Eta1p5_v", 1);


    std::string treeOnlineJetPath = "hltobject/HLT_HIPuAK4CaloJet40Eta5p1_v";
    treeOnlineJet = (TTree*) fileTrig->Get(treeOnlineJetPath.c_str());
    // specify explicitly which branches to use
    treeOnlineJet->SetBranchStatus("*",0); // disable all branches
    treeOnlineJet->SetBranchStatus("pt",1);
    treeOnlineJet->SetBranchStatus("eta",1);
    treeOnlineJet->SetBranchStatus("phi",1);
    ...
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet40Eta5p1_v",&triggerDecision_60);
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet80Eta1p5_v",&triggerDecision_80);
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet100Eta1p5_v",&triggerDecision_100);
    treeTrig->SetBranchAddress("HLT_HICsAK4PFJet120Eta1p5_v",&triggerDecision_120);
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    std::vector<float> *onlineJetPt=0, *onlineJetEta=0, *onlineJetPhi=0;
    ...
    treeOnlineJet->SetBranchAddress("pt",&onlineJetPt);
    treeOnlineJet->SetBranchAddress("eta",&onlineJetEta);
    treeOnlineJet->SetBranchAddress("phi",&onlineJetPhi);
	...
	Float_t weight_Ncoll = findNcoll(hiBin);
	weight *= weight_Ncoll;
        //weight = 1.0;
	...
	if(pthat < 0.35*maxPt_denom) continue;
        
	if(fabs(maxEta_denom)>5.1) continue; // skip event if the leading jet is outside eta range
	...
	//cout << "denomEntries = " << denomEntries << endl;



        treeTrig->GetEntry(i_entry); // get trigger decision from HLT emulation
	treeOnlineJet->GetEntry(i_entry);
        
        
        if(triggerDecision_60) {// only fill the numerator if the trigger is on.
		
	    Float_t maxPt_online = 0;
	    Float_t maxEta_online = 0;
	    Float_t maxPhi_online = 0;

	    for(int k = 0; k < onlineJetPt->size(); k++){
	
	        Float_t onlineJetPt_k = onlineJetPt->at(k);
	        Float_t onlineJetEta_k = onlineJetEta->at(k);
	        Float_t onlineJetPhi_k = onlineJetPhi->at(k);
		
		if(onlineJetPt_k > maxPt_online) {
			maxPt_online = onlineJetPt_k;
			maxEta_online = onlineJetEta_k;
			maxPhi_online = onlineJetPhi_k;
		}	
		...
		for(Int_t j_gen = 0; j_gen < ngen; j_gen++){
			...
			Float_t genJetPt = genpt[j_gen];
			Float_t genJetEta = geneta[j_gen];
			Float_t genJetPhi = genphi[j_gen];

			Float_t recoJetPt = maxPt_num;
			Float_t recoJetEta = maxEta_num;
			Float_t recoJetPhi = maxPhi_num;
			
			Float_t dR_recoGen = getDr(recoJetEta,recoJetPhi,genJetEta,genJetPhi);
		...
		Bool_t hasOnlineMatch = false;		
		
		Float_t matchParam = 0.05;
		
		Float_t minDr = 100;

		Float_t saveOnline_pt = 0;
		Float_t saveOnline_eta = 0;
		Float_t saveOnline_phi = 0;
		

		cout << "-- Event " << i_entry << " --" << endl; 
		for(int k = 0; k < onlineJetPt->size(); k++){
			
			Float_t dR_onlineOffline_k = getDr(maxEta_num,maxPhi_num,onlineJetEta->at(k),onlineJetPhi->at(k));


			cout << "        dR(offlineJet" << i_jet_num << ", onlineJet " << k << " = " << dR_onlineOffline_k << "  |  deltaPt/Pt = " << (maxPt_num - onlineJetPt->at(k))/maxPt_num << endl;

			if(dR_onlineOffline_k < matchParam && dR_onlineOffline_k < minDr){
				
				hasOnlineMatch = true;

				minDr = dR_onlineOffline_k;

				saveOnline_pt = onlineJetPt->at(k);
				saveOnline_eta = onlineJetEta->at(k);
				saveOnline_phi = onlineJetPhi->at(k);
			}	
		...
		if(hasOnlineMatch){
			...
			if(fabs(maxEta_num) < 5.0) h_onlineJetPt_offlineJetPt_60[0]->Fill(saveOnline_pt/maxPt_num,saveOnline_pt,weight);
		       	if(fabs(maxEta_num) < 1.3) h_onlineJetPt_offlineJetPt_60[1]->Fill(saveOnline_pt/maxPt_num,saveOnline_pt,weight);
		       	if(fabs(maxEta_num) > 1.3 && fabs(maxEta_num) < 2.5) h_onlineJetPt_offlineJetPt_60[2]->Fill(saveOnline_pt/maxPt_num,saveOnline_pt,weight);
		       	if(fabs(maxEta_num) > 2.5 && fabs(maxEta_num) < 3.0) h_onlineJetPt_offlineJetPt_60[3]->Fill(saveOnline_pt/maxPt_num,saveOnline_pt,weight);
		       	if(fabs(maxEta_num) > 3.0 && fabs(maxEta_num) < 5.0) h_onlineJetPt_offlineJetPt_60[4]->Fill(saveOnline_pt/maxPt_num,saveOnline_pt,weight);
    ...
    leg->AddEntry(r_60,"HLT_HICsAK4PFJet60Eta1p5_v","p");
    leg->AddEntry(r_80,"HLT_HICsAK4PFJet80Eta1p5_v","p");
    leg->AddEntry(r_100,"HLT_HICsAK4PFJet100Eta1p5_v","p");
    leg->AddEntry(r_120,"HLT_HICsAK4PFJet120Eta1p5_v","p");
    ...
    auto wf = TFile::Open("rootFiles/test.root","recreate");
	...
	for(int i = 0; i < 5; i++){
		...
		h_onlineJetPt_offlineJetPt_60[i]->Write();
